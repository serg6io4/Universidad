...
SELECT * FROM USER_CONSTRAINTS WHERE CONSTRAINT_TYPE LIKE 'R';
SELECT * FROM USER_CONS_COLUMNS WHERE CONSTRAINT_NAME LIKE 'FK%';
 CREATE TABLE TDEP
(CODIGO VARCHAR2(16) PRIMARY KEY, NOMBRE VARCHAR2(16), DIRECTOR VARCHAR2(16));
CREATE TABLE TEMP
(NSS VARCHAR2(16) PRIMARY KEY, NOMBRE VARCHAR2(16), DEPARTAMENTO VARCHAR2(16));
ALTER TABLE TDEP ADD
(CONSTRAINT FK_REN_1 FOREIGN KEY(DIRECTOR) REFERENCES TEMP(NSS));
ALTER TABLE TEMP ADD
(CONSTRAINT FK_REN_2 FOREIGN KEY(DEPARTAMENTO) REFERENCES TDEP(CODIGO));